...
export enum GAME_SOCKET_EVENTS {
    ...
    partner_info_exposed ='partner_info_exposed',/*server expose to socket a data about his partner/partners (name/age/photo etc.) */ 
    /** search for game*/
    ...
    play= 'play',/*client tell server about his play move*/
    //edge cases
...
/**
 * GAME_SOCKET_EVENTS PAYLOD:
 */


export interface partner_info_exposed_PAYLOAD{
        playerId:string,
        infoPropExposed:string,
        infoPropValue:any
}